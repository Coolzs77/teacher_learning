...
- **备用端口 8899**：`curl -I http://47.93.28.243:8899/` -> 返回 `HTTP/1.1 200 OK`。
- **PDF 分片 Range 测试**：
...
#### 【推荐方案 A：真正 100% 永久免费二级域名 + 8899 免备案端口】（手机/电脑通用）
