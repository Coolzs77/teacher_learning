...
4. **全端口与文件验证**：
   - 80 端口访问：`http://47.93.28.243/` ➔ **HTTP 200 OK**
   - 8099 端口访问：`http://47.93.28.243:8099/` ➔ **HTTP 200 OK**
   - 统编教材 PDF Range 请求：`http://47.93.28.243/textbooks/...` ➔ **HTTP 206 Partial Content**（分片流式加载秒开）。
